...
namespace KhumaloCraft_.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public AboutsController(KhumaloCraft_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,about")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,about")] About about)
        {
            if (id != about.Id)
            {
                return NotFound();
